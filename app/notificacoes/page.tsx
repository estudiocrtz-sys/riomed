...
import { Bell, CheckCircle2, FileText, Calendar, AlertCircle, Info, X } from 'lucide-react'
      ...
      <div className="flex-1 p-8 space-y-6">
        ...
        {unread.length > 0 && (
          <div className="flex justify-end">
            <button onClick={markAllRead} className="text-sm text-[#03624C] font-medium hover:text-[#2CC295] transition-colors">
