...
import { doctors, getDoctorsByUnit } from '@/data/doctors'
import { MapPin, Clock, Phone, Mail, Calendar, ChevronDown, ChevronUp, ParkingCircle, Accessibility } from 'lucide-react'
    ...
    <AppShell>
      ...
      <div className="flex-1 p-8 space-y-4">
        {units.map((u) => {
          ...
          return (
            <div key={u.id} className="bg-white rounded-2xl border border-[#E8EDE9] overflow-hidden">
              {/* Header */}
              <button
              ...
              >
                ...
                <div className="flex items-center gap-3 flex-shrink-0">
                  ...
                  {isExpanded ? <ChevronUp className="w-4 h-4 text-[#8A9390]" /> : <ChevronDown className="w-4 h-4 text-[#8A9390]" />}
                </div>
              </button>
